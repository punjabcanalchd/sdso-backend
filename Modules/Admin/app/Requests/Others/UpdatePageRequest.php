    ...
    */
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'slug' => ['required','string','max:255',Rule::unique('pages', 'slug')->ignore($pageId, 'page_id')],
    ...
    */
    ...
    public function messages(): array
    {
        return [
            ...
            'page_banner.mimes' =>
                'Page banner must be a JPG, JPEG, or PNG image.',

            'page_banner.max' =>
                'Page banner must not exceed 5 MB.',

            'page_banner.dimensions' =>
                'Page banner dimensions must be exactly 1366 x 350 pixels.',
        ];
    }
}